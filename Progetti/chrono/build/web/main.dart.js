...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  var _milliseconds = dart.privateName(main, "_milliseconds");
  ...
  var _togglePause = dart.privateName(main, "_togglePause");
  ...
  main._StopWatchPageState = class _StopWatchPageState extends framework.State$(main.StopWatchPage) {
    ...
    [_start]() {
      this[_secondsController] = T.StreamControllerOfint().new();
      let tickerStream = this[_ticker]();
      this[_tickerSub] = tickerStream.listen(dart.fn(tick => {
        let t0;
        if (!this[_paused]) {
          this.setState(dart.fn(() => this[_milliseconds] = this[_milliseconds] + 100, T.VoidTovoid()));
          if (this[_milliseconds][$modulo](1000) === 0) {
            t0 = this[_secondsController];
            t0 == null ? null : t0.add((this[_milliseconds] / 1000)[$truncate]());
          }
        }
      }, T.intTovoid()));
    ...
    [_togglePause]() {
      this.setState(dart.fn(() => this[_paused] = !this[_paused], T.VoidTovoid()));
    }
    dispose() {
      let t0, t0$;
      t0 = this[_tickerSub];
    ...
    [_formatTime](ms) {
      let totalSeconds = (ms / 1000)[$truncate]();
      let minutes = (totalSeconds / 60)[$truncate]();
      let seconds = totalSeconds[$modulo](60);
      let decimi = (ms[$modulo](1000) / 100)[$truncate]();
      return minutes[$toString]()[$padLeft](2, "0") + ":" + seconds[$toString]()[$padLeft](2, "0") + "." + dart.str(decimi);
    }
    build(context) {
      let t0;
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[2] || CT.C2}), body: new basic.Center.new({child: new (T.StreamBuilderOfint()).new({stream: (t0 = this[_secondsController], t0 == null ? null : t0.stream), builder: dart.fn((context, snapshot) => new text.Text.new(this[_formatTime](this[_milliseconds]), {style: C[3] || CT.C3}), T.BuildContextAndAsyncSnapshotOfintToText())})}), floatingActionButton: new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.end, children: T.JSArrayOfWidget().of([new floating_action_button.FloatingActionButton.new({heroTag: "start_reset", onPressed: !this[_running] ? dart.bind(this, _start) : dart.bind(this, _reset), child: new icon.Icon.new(!this[_running] ? icons.Icons.play_arrow : icons.Icons.refresh)}), C[5] || CT.C5, new floating_action_button.FloatingActionButton.new({heroTag: "pause_resume", onPressed: this[_running] ? dart.bind(this, _togglePause) : null, backgroundColor: this[_running] ? colors.Colors.blue : colors.Colors.grey, child: new icon.Icon.new(this[_paused] ? icons.Icons.play_arrow : icons.Icons.pause)})])})});
    }
  ...
  dart.setMethodSignature(main._StopWatchPageState, () => ({
    ...
    [_seconds]: dart.fnType(async.Stream$(core.int), [async.Stream$(core.int)]),
    [_start]: dart.fnType(dart.void, []),
    [_reset]: dart.fnType(dart.void, []),
    [_togglePause]: dart.fnType(dart.void, []),
  ...
  dart.setFieldSignature(main._StopWatchPageState, () => ({
    ...
    [_secondsController]: dart.fieldType(dart.nullable(async.StreamController$(core.int))),
    [_milliseconds]: dart.fieldType(core.int),
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;A